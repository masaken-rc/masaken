            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <input 
                        ...
                        onChange={handleInfoChange}
                        className="w-full px-4 py-3 rounded-lg border border-gray-200 focus:border-accent focus:ring-1 focus:ring-accent outline-none transition-all dir-ltr"
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 pt-6 border-t border-gray-100">
                <div>
                    ...
                    <div 
                        ...
                        className="border-2 border-dashed border-gray-300 rounded-xl p-6 text-center cursor-pointer hover:border-accent hover:bg-accent/5 transition-all group"
                    >
                        {projectInfo.main_image ? (
                            ...
                            <div className="py-8">
                                <Upload className="w-10 h-10 text-gray-400 mx-auto mb-3 group-hover:text-accent" />
                ...
                <div>
                    ...
                    <div 
                        ...
                        className="border-2 border-dashed border-gray-300 rounded-xl p-6 text-center cursor-pointer hover:border-accent hover:bg-accent/5 transition-all h-[150px] flex items-center justify-center group"
                    >
                         {projectInfo.brochure ? (
                            ...
                            <div>
                                <Upload className="w-8 h-8 text-gray-400 mx-auto mb-2 group-hover:text-accent" />
             ...
             <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="space-y-6">
                 <div className="flex justify-between items-center mb-6">
                     ...
                     <button 
                        ...
                        className="flex items-center gap-2 px-4 py-2 border border-accent text-accent rounded-lg hover:bg-accent hover:text-white transition-all"
                     >
                         <Plus size={16} />
                         <span>إضافة صور</span>
                     </button>
