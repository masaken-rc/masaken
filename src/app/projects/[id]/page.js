    ...
    <main className="min-h-screen bg-[#f9f9f9]">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-10">
          ...
          <div className="lg:col-span-1 space-y-8">
            ...
            <div className="bg-white p-8 rounded-3xl shadow-sm border border-border-light sticky top-8">
              ...
              <div className="space-y-4 mb-8">
                <a href="tel:+966509996115" className="flex items-center gap-4 p-4 rounded-xl bg-gray-50 hover:bg-gray-100 transition-colors">
                  ...
                  <div>
                    ...
                    <span className="font-bold text-primary dir-ltr">0509996115</span>
                  </div>
                </a>
              ...
              <a 
                href={`https://wa.me/966509996115?text=${encodeURIComponent(`أرغب في حجز موعد لزيارة مشروع ${project.name}`)}`}
                target="_blank"
                rel="noopener noreferrer"
      ...
      <footer className="bg-[#111] text-white py-12 text-center text-sm border-t border-gray-800 flex flex-col items-center gap-6 mt-12">
        <div className="w-20 h-20 bg-white/5 rounded-full flex items-center justify-center p-4">
          <img src="/images/logo.png" alt="مساكن الرفاهية" className="w-full h-full object-contain opacity-90" />
        </div>
        <p>&copy; {new Date().getFullYear()} مساكن الرفاهية للتطوير العقاري. جميع الحقوق محفوظة.</p>
      </footer>
    </main>
  );
}
